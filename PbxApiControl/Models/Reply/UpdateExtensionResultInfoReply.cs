...
{
    public class UpdateExtensionResultInfoReply
    {
        public static UpdateExtensionInfoReply FormatUpdateExtensionResultInfo(ExtensionInfo extensionInfo)
        {
            return new UpdateExtensionInfoReply
            {
